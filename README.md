# factbook - scripts for the world factbook (turn the country profile web pages into open structured data e.g JSON, produce your own personal world almanac, import data into database for SQL queries, etc.)
